...
Credit to [Mahattam Tomar](https://github.com/mattyait) and his project https://github.com/mattyait/terraform-aws-network-firewall for helpful examples.
...
| <a name="input_cloudwatch_logs"></a> [cloudwatch\_logs](#input\_cloudwatch\_logs) | send firewall logs to cloudwatch log group. If unset, logs will not be sent. Allowed values are "ALERT" and "FLOW". | `string` | `""` | no |
...
| Name | Type |
|------|------|
| [aws_cloudwatch_log_group.egress_firewall](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_log_group) | resource |
